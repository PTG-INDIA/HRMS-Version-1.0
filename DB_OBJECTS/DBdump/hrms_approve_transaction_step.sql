...
--
-- Table structure for table `approve_transaction_step`
--

DROP TABLE IF EXISTS `approve_transaction_step`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `approve_transaction_step` (
...
--
-- Dumping data for table `approve_transaction_step`
--

LOCK TABLES `approve_transaction_step` WRITE;
/*!40000 ALTER TABLE `approve_transaction_step` DISABLE KEYS */;
/*!40000 ALTER TABLE `approve_transaction_step` ENABLE KEYS */;
UNLOCK TABLES;
